    ...
    >
          ...
          <TextField
            ...
            InputProps={{
              style: {
                ...
                borderRadius: '8px',
                borderColor: theme.palette.mode === 'light' ? '#cccccc' : '#414141'
              }
            }}
            InputLabelProps={{ style: { color: theme.palette.mode === 'light' ? '#717171' : '#cccccc' } }}
            sx={{
              '& .MuiOutlinedInput-root': {
                ...
                '&:hover fieldset': {
                  borderColor: theme.palette.mode === 'light' ? '#000' : '#e81cff'
                },
      ...
      <Button
        ...
        sx={{
          ...
          fontWeight: 600,
          background: theme.palette.mode === 'light' ? 'rgba(240, 240, 240, 0.8)' : '#313131',
          border: `1px solid ${theme.palette.mode === 'light' ? '#cccccc' : '#414141'}`,
          padding: '12px 16px',
          fontSize: 'inherit',
          gap: '8px',
          marginTop: '8px',
          ...
          borderRadius: '6px',
          '&:hover': {
            backgroundColor: theme.palette.mode === 'light' ? '#e0e0e0' : '#fff',
